...
public class AlbumsUpdateScheduler {
    ...
    private final org.superbiz.moviefun.albums.AlbumsUpdater albumsUpdater;
    private final Logger logger = LoggerFactory.getLogger(getClass());

    public AlbumsUpdateScheduler(DataSource dataSource, org.superbiz.moviefun.albums.AlbumsUpdater albumsUpdater) {
